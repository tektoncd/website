...
Check out the [Getting Started Tutorial](https://tekton.dev/docs/chains/getting-started-tutorial/) to spin up a local cluster, generate a keypair, and start signing your first TaskRuns today.
