...
-   A [Kubernetes cluster][k8s] running version 1.22 or later.
-   [Kubectl][].
...
You can enable additional alpha an beta features, customize execution
parameters, configure availability, and many more options. See the
[post-installation configurations][post-install] for more information.

[post-install]: /docs/pipelines/post-install
